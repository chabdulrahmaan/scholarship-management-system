      ...
      <section class="wrapper style4 container">
        ...
        <div class="content">
          <section>
            ...
            <header>
              <h1><b style="margin: 10% 0% 0% 42%;">User Profile</b></h1>
            </header>
            ...
            <div id="display">
              <form method="post" action="../backend/userdata.php" class="form-horizontal" role="form">
                ...
                <?php if ($middleName == NULL || $middleName == "") {
                } else { ?>
                  <div class="form-group">
                ...
                <?php if ($nationality == NULL || $nationality == "") {
                } else { ?>
                  <div class="form-group">
                ...
                <?php if ($birthDate == NULL || $birthDate == "0000-00-00") {
                } else { ?>
                  <div class="form-group">
                ...
                <?php if ($birthPlace == NULL || $birthPlace == "") {
                } else { ?>
                  <div class="form-group">
                ...
                <?php if ($presStreetAddr == NULL || $presStreetAddr == "") {
                } else { ?>
                  <div class="form-group">
                ...
                <?php if ($presProvCity == NULL || $presProvCity == "") {
                } else { ?>
                  <div class="form-group">
                ...
                <?php if ($presRegion == NULL || $presRegion == "") {
                } else { ?>
                  <div class="form-group">
                ...
                <?php if ($permStreetAddr == NULL || $permStreetAddr == "") {
                } else { ?>
                  <div class="form-group">
                ...
                <?php if ($permProvCity == NULL || $permProvCity == "") {
                } else { ?>
                  <div class="form-group">
                ...
                <?php if ($permRegion == NULL || $permRegion == "") {
                } else { ?>
                  <div class="form-group">
                ...
                <?php if ($contactNo == NULL || $contactNo == "0") {
                } else { ?>
                  <div class="form-group">
            ...
            <div id="editDiv" style="display:none">
              <form method="POST" action="../backend/userdata.php" class="form-horizontal" role="form">
                ...
                <div class="form-group">
                  <label class="control-label col-sm-2" for="contactNo">Contact Number:</label>
                  <div class="col-sm-10">
                    <input type="name" class="form-control" name="contactNo" value="<?php if ($contactNo != '0') {
                                                                                      echo $contactNo;
                                                                                    } ?>">
                  </div>
                </div>
